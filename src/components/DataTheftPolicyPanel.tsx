...
import './DataTheftPolicyPanel.css'
import { PrimaryButton, DefaultButton, IconButton, Icon, TextField, MessageBar, MessageBarType, Link } from '@fluentui/react'

interface DataTheftPolicyPanelProps {
  onClose: () => void
}

const DataTheftPolicyPanel = ({ onClose }: DataTheftPolicyPanelProps) => {
  const [policyName, setPolicyName] = useState('Non-Microsoft 365 data theft (quick policy) - 2/4/2026')
  ...
  return (
    <aside className="data-theft-policy-panel">
      <div className="policy-panel-header">
        <h2>Create a data theft policy for non-Microsoft 365 apps</h2>
        <IconButton
...
export default DataTheftPolicyPanel
