...
const FabricPolicyCreationPanel = ({ onClose }: FabricPolicyCreationPanelProps) => {
  ...
  return (
    <div className="policy-dialog-overlay">
      <div className="policy-dialog-container fabric-policy-dialog">
        <div className="policy-panel-header">
          <h2>Create a data leaks policy for Microsoft Fabric</h2>
          <IconButton
...
export default FabricPolicyCreationPanel
